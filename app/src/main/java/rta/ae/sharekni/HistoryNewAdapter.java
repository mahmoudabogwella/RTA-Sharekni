 ...
 */
public class HistoryNewAdapter  extends ArrayAdapter<BestRouteDataModel> {
    ...
    public HistoryNewAdapter(Activity activity, int resource, BestRouteDataModel[] objects) {
